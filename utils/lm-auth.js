 ...
 * - Sets up window.LMAuth global namespace for access from other scripts
 * - Immediately available after script load
 * 
 * LAST UPDATED: January 2025
 * VERSION: 1.1.0 (Webflow Compatible)
...
(function() {
     ...
     */
    async function getCurrentLMIDCount() {
        const authSystem = getAuthSystem();
    ...
    if (typeof window !== 'undefined') {
        ...
        console.log("✅ LM Auth System loaded and available at window.LMAuth");
    }
