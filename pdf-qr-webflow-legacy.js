...
(function() {
    ...
    /**
     * Initialize PDF QR links when DOM is ready (OPTIMIZED - Batch Loading)
     */
    async function initializePdfQrLinks() {
        ...
        console.log(`📋 Found ${pdfButtons.length} PDF QR buttons - using BATCH loading`);
        ...
        try {
            // BATCH FETCH: Get all workbook items in one API call
            console.log('📡 Fetching all workbook items from cache...');
            ...
            // Process each button using cached data
