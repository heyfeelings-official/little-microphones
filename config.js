...
(function() {
    ...
    window.LM_CONFIG.EMAIL = {
        ...
        TEMPLATES: {
            TEACHER_NOTIFICATION_PL: 10, // Template ID for Polish teacher notifications
            TEACHER_NOTIFICATION_EN: 8,  // Template ID for English teacher notifications
            PARENT_NOTIFICATION_PL: 7,   // Template ID for Polish parent notifications
