...
(function() {
    ...
    async function createRecordingElement(recordingData, questionId, getAudioSource, deleteRecording, dispatchUploadStatusEvent, options = {}) {
        ...
        playerContainer.style.cssText = `width: 100%; height: 48px; position: relative; background: #ffffff; border-radius: 122px; display: flex; align-items: center; padding: 0 8px 0 0; box-sizing: border-box;`;
